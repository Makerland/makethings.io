...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Organizer.user2'
        db.add_column(u'event_organizer', 'user2',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['event.User'], unique=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Organizer.user2'
        db.delete_column(u'event_organizer', 'user2_id')
