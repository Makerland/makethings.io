...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Website.makerland_photo'
        db.add_column(u'event_website', 'makerland_photo',
                      self.gf('django.db.models.fields.files.ImageField')(default=None, max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Website.makerland_photo'
        db.delete_column(u'event_website', 'makerland_photo')
