...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('event_organizer', 'user2_id', 'user_id')

    def backwards(self, orm):
        db.rename_column('event_organizer', 'user_id', 'user2_id')
    ...
    models = {
        ...
        u'event.organizer': {
            ...
            'user': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['event.User']", 'unique': 'True', 'null': 'True'})
        },
        u'event.sponsor': {
