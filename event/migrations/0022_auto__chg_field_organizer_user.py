...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Organizer.user'
        db.alter_column(u'event_organizer', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(default=0, to=orm['event.User'], unique=True))

    def backwards(self, orm):

        # Changing field 'Organizer.user'
        db.alter_column(u'event_organizer', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['event.User'], unique=True, null=True))
