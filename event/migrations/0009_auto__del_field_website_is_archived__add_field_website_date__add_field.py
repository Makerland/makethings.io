...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Website.is_archived'
        db.delete_column(u'event_website', 'is_archived')

        # Adding field 'Website.date'
        db.add_column(u'event_website', 'date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Website.status'
        db.add_column(u'event_website', 'status',
    ...
    def backwards(self, orm):
        # Adding field 'Website.is_archived'
        db.add_column(u'event_website', 'is_archived',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Website.date'
        db.delete_column(u'event_website', 'date')

        # Deleting field 'Website.status'
        db.delete_column(u'event_website', 'status')
    ...
    models = {
        ...
        u'event.event': {
            ...
            'team': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'team'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['event.Organizer']"})
        },
        u'event.faq': {
        ...
        u'event.website': {
            ...
            'status': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'team': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'team2'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['event.Organizer']"}),
