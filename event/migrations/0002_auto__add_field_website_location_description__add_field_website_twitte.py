...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Website.location_description'
        db.add_column(u'event_website', 'location_description',
                      self.gf('django.db.models.fields.TextField')(default='', null=True, blank=True),
                      keep_default=False)

        # Adding field 'Website.twitter_handle'
        db.add_column(u'event_website', 'twitter_handle',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Website.location_description'
        db.delete_column(u'event_website', 'location_description')

        # Deleting field 'Website.twitter_handle'
        db.delete_column(u'event_website', 'twitter_handle')
