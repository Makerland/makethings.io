...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('event_event', 'main_organizer1_id', 'main_organizer_id')
        db.rename_table(db.shorten_name(u'event_website_team1'), db.shorten_name(u'event_website_team'))

    def backwards(self, orm):
        db.rename_column('event_event', 'main_organizer', 'main_organizer1')
        db.rename_table(db.shorten_name(u'event_website_team'), db.shorten_name(u'event_website_team1'))
