...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'event_event', 'status')

        # Deleting field 'Event.date'
        db.delete_column(u'event_event', 'date')

        # Removing M2M table for field team on 'Event'
        db.delete_table(db.shorten_name(u'event_event_team'))


    def backwards(self, orm):
        # Adding field 'Event.status'
        db.add_column(u'event_event', 'status',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Event.date'
        db.add_column(u'event_event', 'date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 5, 18, 0, 0)),
                      keep_default=False)

        # Adding M2M table for field team on 'Event'
        m2m_table_name = db.shorten_name(u'event_event_team')
