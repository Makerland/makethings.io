...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'event_organizer', 'user_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Organizer.user'
        raise RuntimeError("Cannot reverse this migration. 'Organizer.user' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Organizer.user'
        db.add_column(u'event_organizer', 'user',
    ...
    models = {
        ...
        u'event.organizer': {
            ...
            'user2': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['event.User']", 'unique': 'True', 'null': 'True'})
        },
        u'event.sponsor': {
