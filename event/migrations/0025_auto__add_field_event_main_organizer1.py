...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field team1 on 'Website'
        m2m_table_name = db.shorten_name(u'event_website_team1')
        ...
        # Adding field 'Event.main_organizer1'
        db.add_column(u'event_event', 'main_organizer1',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['event.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Removing M2M table for field team1 on 'Website'
        db.delete_table(db.shorten_name(u'event_website_team1'))

        # Deleting field 'Event.main_organizer1'
        db.delete_column(u'event_event', 'main_organizer1_id')
