...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Event.main_organizer'
        db.delete_column(u'event_event', 'main_organizer_id')
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'event_organizer', (
            ...
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['event.User'], unique=True)),
        ...
        db.create_unique(m2m_table_name, ['website_id', 'organizer_id'])


        # User chose to not deal with backwards NULL issues for 'Event.main_organizer'
        raise RuntimeError("Cannot reverse this migration. 'Event.main_organizer' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Event.main_organizer'
        db.add_column(u'event_event', 'main_organizer',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='main_organizer', to=orm['event.Organizer']),
                      keep_default=False)
    ...
    models = {
        ...
        u'event.event': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'main_organizer1': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': u"orm['event.User']"})
        },
        u'event.faq': {
        ...
        u'event.website': {
            ...
            'team1': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'websites'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['event.User']"}),
