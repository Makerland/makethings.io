...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FAQ.website'
        db.delete_column(u'event_faq', 'website_id')


    def backwards(self, orm):
        # Adding field 'FAQ.website'
        db.add_column(u'event_faq', 'website',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['event.Website']),
                      keep_default=False)
