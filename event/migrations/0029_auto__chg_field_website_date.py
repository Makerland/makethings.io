...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Website.date'
        db.alter_column(u'event_website', 'date', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Website.date'
        db.alter_column(u'event_website', 'date', self.gf('django.db.models.fields.DateField')(null=True))
