...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'WorkshopLeader.website'
        db.delete_column(u'event_workshopleader', 'website_id')

        # Adding field 'WorkshopLeader.event'
        db.add_column(u'event_workshopleader', 'event',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='workshop_leaders', to=orm['event.Event']),
                      keep_default=False)

        # Adding field 'User.event'
        db.add_column(u'event_user', 'event',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='organizers', null=True, to=orm['event.Event']),
                      keep_default=False)

        # Adding field 'User.twitter'
        db.add_column(u'event_user', 'twitter',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'User.photo'
        db.add_column(u'event_user', 'photo',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'WorkshopLeader.website'
        db.add_column(u'event_workshopleader', 'website',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['event.Website'], null=True),
                      keep_default=False)

        # Deleting field 'WorkshopLeader.event'
        db.delete_column(u'event_workshopleader', 'event_id')

        # Deleting field 'User.event'
        db.delete_column(u'event_user', 'event_id')

        # Deleting field 'User.twitter'
        db.delete_column(u'event_user', 'twitter')

        # Deleting field 'User.photo'
        db.delete_column(u'event_user', 'photo')
    ...
    models = {
        ...
        u'event.organizer': {
            ...
            'user': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['event.User']", 'unique': 'True'})
        },
        u'event.sponsor': {
