...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Website.location_photo'
        db.add_column(u'event_website', 'location_photo',
                      self.gf('django.db.models.fields.files.ImageField')(default=None, max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Website.apply_photo'
        db.add_column(u'event_website', 'apply_photo',
                      self.gf('django.db.models.fields.files.ImageField')(default=None, max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Website.howitworks_photo'
        db.add_column(u'event_website', 'howitworks_photo',
                      self.gf('django.db.models.fields.files.ImageField')(default=None, max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Website.social_photo'
        db.add_column(u'event_website', 'social_photo',
                      self.gf('django.db.models.fields.files.ImageField')(default=None, max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Website.location_photo'
        db.delete_column(u'event_website', 'location_photo')

        # Deleting field 'Website.apply_photo'
        db.delete_column(u'event_website', 'apply_photo')

        # Deleting field 'Website.howitworks_photo'
        db.delete_column(u'event_website', 'howitworks_photo')

        # Deleting field 'Website.social_photo'
        db.delete_column(u'event_website', 'social_photo')
