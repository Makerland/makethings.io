...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Organizer.photo'
        db.alter_column(u'event_organizer', 'photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Organizer.photo'
        db.alter_column(u'event_organizer', 'photo', self.gf('django.db.models.fields.files.ImageField')(default=None, max_length=100))
    ...
    models = {
        ...
        u'event.event': {
            ...
            'team': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'team'", 'symmetrical': 'False', 'to': u"orm['event.Organizer']"})
        },
        u'event.faq': {
