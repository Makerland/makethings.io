...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Website.twitter_url'
        db.delete_column('event_website', 'twitter_url')

        # Deleting field 'Website.gplus_url'
        db.delete_column('event_website', 'gplus_url')


    def backwards(self, orm):
        # Adding field 'Website.twitter_url'
        db.add_column('event_website', 'twitter_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Website.gplus_url'
        db.add_column('event_website', 'gplus_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'event.workshopleader': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'photo': ('django.db.models.fields.files.ImageField', [], {'max_length': '100'}),
            'website': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['event.Website']", 'null': 'True'})
        }
    }
