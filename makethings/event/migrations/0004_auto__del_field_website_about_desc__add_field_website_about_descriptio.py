...
class Migration(SchemaMigration):
	...
	def forwards(self, orm):
		...
		# Adding field 'Website.about_description'
		db.add_column('event_website', 'about_description',
	...
	def backwards(self, orm):
		...
		# Deleting field 'Website.about_description'
		db.delete_column('event_website', 'about_description')
